...
public interface PostService {
     ...
     * (пользователя или сообщества); если дополнительно передан {@code albumId},
     * из результата исключаются публикации, входящие в этот альбом.
     * </p>
     *
     * @param query поисковый запрос
     * @param authorUuid UUID автора публикаций (пользователя или сообщества), или {@code null},
     *                   чтобы искать среди всех публикаций
     ...
     */
    Page<PostResponse> getPostsBySearch(String query, UUID authorUuid, UUID albumId, Pageable pageable);
